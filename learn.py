...
def render():
    ...
    with st.form("learn_quiz_form"):
        ...
        for idx, q in enumerate(questions):
            ...
            if q['type'] == 'mcq':
                ...
                # In my generated curriculum, even fill has options for easy answering, simulating drop-downs or just MCQ format for fill-ups. 
                # Let's use radio for fill too since I provided options in the script to make it easy on mobile.
    ...
    if submitted:
        ...
        if passed:
            ...
            st.error("⚠️ You need 15/15 to pass this module. Review your mistakes below and try again.")
